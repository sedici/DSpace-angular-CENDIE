...
@listableObjectComponent('PublicationSearchResult', ViewMode.ListElement, Context.Any, 'dspace')
@listableObjectComponent(ItemSearchResult, ViewMode.ListElement, Context.Any, 'dspace')
@Component({
